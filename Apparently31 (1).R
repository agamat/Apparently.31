...
ukcc<- read.csv('/Users/Ahmed/Google Drive/Thesis/First\ Paper\ analysis/First_paper/uksi.csv') 
...
c_p<- openxlsx::read.xlsx('/Users/Ahmed/Google Drive/Thesis/First\ Paper\ analysis/First_paper/portss.xlsx', sheet = "c_p", colNames=FALSE)  
...
m_p$X92<-NULL # remove unavailable data
m_p$X109<-NULL # remove unavailable data
m_v$X92<-NULL # remove unavailable data
m_v$X109<-NULL # remove unavailable data
